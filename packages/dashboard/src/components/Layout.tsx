...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen bg-gray-950 text-gray-100">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-30 w-64 transform bg-gray-900 border-r border-gray-800 transition-transform duration-200 ease-in-out xl:relative xl:translate-x-0 ${
          sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        }`}
      >
        <div className="flex h-16 items-center gap-2 px-6 border-b border-gray-800">
          <div className="h-8 w-8 rounded-lg bg-brand-600 flex items-center justify-center font-bold text-sm">
            DP
          </div>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-16 items-center justify-between border-b border-gray-800 px-6">
          <button
            className="xl:hidden p-2 rounded-lg hover:bg-gray-800"
